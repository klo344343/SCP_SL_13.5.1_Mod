...
namespace Hints
{
    public class ShortHintParameter : PrimitiveHintParameter<short>
    {
        ...
        protected ShortHintParameter()
            : base((Func<NetworkReader, short>)NetworkReaderExtensions.ReadShort, 
                  (Action<NetworkWriter, short>)NetworkWriterExtensions.WriteShort)
        {
        }

        public ShortHintParameter(short value)
            : base(value, (Func<NetworkReader, short>)NetworkReaderExtensions.ReadShort, 
                  (Action<NetworkWriter, short>)NetworkWriterExtensions.WriteShort)
        {
        }
    }
