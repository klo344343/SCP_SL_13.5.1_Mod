	...
	public class HumanVoiceModule : StandardVoiceModule, IRadioVoiceModule
	{
        ...
        private bool Transmitting
        {
            ...
            set
            {
                ...
                {
                    AudioSourcePoolManager.PlaySound((value ? _radioOnSounds : _radioOffSounds).RandomItem(), null, 0f, _toggleSoundsVolume, FalloffType.Exponential, AudioMixerChannelType.VoiceChat, 0f);
