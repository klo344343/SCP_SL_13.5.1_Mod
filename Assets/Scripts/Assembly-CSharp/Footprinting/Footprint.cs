    ...
    public readonly struct Footprint : IEquatable<Footprint>
    {
        ...
        public string UnitName
        {
            get
            {
                ...
                if (!UnitNameMessageHandler.ReceivedNames.TryGetValue(result.AssignedSpawnableTeam, out var value))
                {
                    return string.Empty;
                }
        ...
        public Footprint(ReferenceHub hub)
        {
            ...
            Role = (flag ? RoleTypeId.None : hub.GetRoleId());
            Unit = (byte)((!flag && hub.roleManager.CurrentRole is HumanRole humanRole) ? humanRole.UnitNameId : 0);
            LogUserID = (flag ? string.Empty : hub.authManager.UserId);
        ...
        public bool SameLife(Footprint other)
        {
