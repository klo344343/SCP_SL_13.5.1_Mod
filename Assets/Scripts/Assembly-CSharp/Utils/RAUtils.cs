        ...
        public static List<ReferenceHub> ProcessPlayerIdOrNamesList(ArraySegment<string> args, int startindex, out string[] newargs, bool keepEmptyEntries = false)
        {
            try
            {
                ...
                if (text.StartsWith("@", StringComparison.Ordinal))
                {
                    ...
                    newargs = text.Split(new char[1] { ' ' }, (!keepEmptyEntries) ? StringSplitOptions.RemoveEmptyEntries : StringSplitOptions.None);
                    return list;
                }
                ...
                newargs = ((args.Count > 1) ? FormatArguments(args, startindex + 1).Split(new char[1] { ' ' }, (!keepEmptyEntries) ? StringSplitOptions.RemoveEmptyEntries : StringSplitOptions.None) : null);
                return list;
            }
