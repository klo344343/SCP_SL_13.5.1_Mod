...
namespace UserSettings.ControlsSettings
{
    public static class SensitivitySettings
    {
        ...
        {
            get => _sensMultiplier.Value;
            set => _sensMultiplier.Value = value;
        }

        public static float AdsReductionMultiplier
        {
            get => _adsReductionMultiplier.Value;
            set => _adsReductionMultiplier.Value = value;
        }
        ...
        private static void Init()
        {
            ...
            UserSetting<float>.SetDefaultValue(SensitivitySetting.AdsReductionMultiplier, 0.7f);
            UserSetting<bool>.SetDefaultValue(SensitivitySetting.Invert, false);
