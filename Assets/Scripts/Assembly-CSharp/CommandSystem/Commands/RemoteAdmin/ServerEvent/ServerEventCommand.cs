...
namespace CommandSystem.Commands.RemoteAdmin.ServerEvent
{
	...
	public class ServerEventCommand : ParentCommand, IUsageProvider
	{
		...
		public override void LoadGeneratedCommands()
		{
			...
			RegisterCommand(new ForceCICommand());
			RegisterCommand(new ForceMTFCommand());
			RegisterCommand(new PlayEffectCICommand());
			RegisterCommand(new PlayEffectMTFCommand());
			RegisterCommand(new RespawnCICommand());
			RegisterCommand(new RespawnMTFCommand());
			RegisterCommand(new RoundRestartCommand());
			RegisterCommand(new TerminateUnconnectedCommand());
			RegisterCommand(new TokenResetCommand());
		}
	}
}
