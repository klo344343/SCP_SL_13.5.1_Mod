...
namespace CommandSystem.Commands.RemoteAdmin.PermissionsManagement.Group
{
	...
	public class RevokeCommand : ICommand, IUsageProvider
	{
		...
		public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
		{
			...
			text3 += "]";
			ServerLogs.AddLog(ServerLogs.Modules.Administrative, sender.LogName + " revoked permission " + text2 + " to group " + text + ".", ServerLogs.ServerLogType.RemoteAdminActivity_Misc);
