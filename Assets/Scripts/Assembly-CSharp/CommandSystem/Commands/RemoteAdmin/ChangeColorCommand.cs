...
namespace CommandSystem.Commands.RemoteAdmin
{
	...
	public class ChangeColorCommand : ICommand, IUsageProvider
	{
		...
		public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
		{
			...
			RoomIdentifier roomIdentifier = RoomIdUtils.RoomAtPosition(playerCommandSender.ReferenceHub.transform.position);
			RoomLightController roomLightController = ((roomIdentifier != null) ? roomIdentifier.GetComponentInChildren<RoomLightController>() : null);
			...
			{
				roomLightController.OverrideColor = Color.clear;
			...
			roomLightController.OverrideColor = new Color(result / 255f, result2 / 255f, result3 / 255f);
