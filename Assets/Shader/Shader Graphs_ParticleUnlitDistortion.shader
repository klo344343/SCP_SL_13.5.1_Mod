Shader "Shader Graphs/ParticleUnlitDistortion" {
	Properties {
		[NoScaleOffset] Texture2D_23DD87FD ("Albedo", 2D) = "white" {}
		[NoScaleOffset] [Normal] Texture2D_D1349F11 ("NormalMap", 2D) = "bump" {}
		Vector1_4664B72E ("DistortionStrength", Float) = 1
		Vector1_CB02A382 ("DistortionBlend", Range(0, 1)) = 0.5
