Shader "Shader Graphs/MicroHIDLaser" {
	Properties {
		[NoScaleOffset] _PosTexture ("PosTexture", 2D) = "white" {}
		_NumOfFrames ("NumOfFrames", Float) = 128
		_Speed ("Speed", Float) = 0
		_Force ("Force", Float) = 0
		[HDR] _ColorIntensity ("ColorIntensity", Vector) = (0,0,0,0)
