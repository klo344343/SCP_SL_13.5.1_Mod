Shader "Shader Graphs/NVSight" {
	Properties {
		[NoScaleOffset] _Crosshair ("Crosshair", 2D) = "white" {}
		[HDR] _VisionColor ("VisionColor", Vector) = (1,1,1,1)
		_NoiseColor ("NoiseColor", Vector) = (0,0.05327413,0.1415094,1)
		_CenterScreenRemap ("CenterScreenRemap", Vector) = (0,1,0,0)
		[ToggleUI] _DebugMode ("DebugMode", Float) = 0
		_MinimalDistance ("MinimalDistance", Float) = 0
		[NoScaleOffset] _Filter ("Filter", 2D) = "white" {}
		[NoScaleOffset] _Texture2DAsset_5feda8d253f242f987d69e0db719cfc6_Out_0 ("Texture2D", 2D) = "white" {}
