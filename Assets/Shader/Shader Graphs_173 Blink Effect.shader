Shader "Shader Graphs/173 Blink Effect" {
	Properties {
		[HDR] _Top_Light ("Top Light", Vector) = (1,0.4539182,0.0235849,1)
		_AlphaRemap ("AlphaRemap", Vector) = (0.02,0.4,0,0)
		_FresnelPow ("FresnelPow", Float) = 4
