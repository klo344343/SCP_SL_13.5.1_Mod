Shader "Shader Graphs/ParticleUnlit" {
	Properties {
		[NoScaleOffset] Texture2D_23DD87FD ("Albedo", 2D) = "white" {}
		_Bloom ("Bloom", Float) = 1
		[Toggle(_FLIPBOOK)] _FLIPBOOK ("Flipbook", Float) = 0
		[Toggle(_CAMERAFADE)] _CAMERAFADE ("CameraFade", Float) = 0
		[Toggle(_SOFTPARTICLES)] _SOFTPARTICLES ("SoftParticles", Float) = 0
		_FadeRange ("FadeRange", Range(1, 10)) = 1
