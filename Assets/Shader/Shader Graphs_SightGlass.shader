Shader "Shader Graphs/SightGlass" {
	Properties {
		_MinMaxDistance ("MinMaxDistance", Vector) = (0,1,0,0)
		_RemapOut ("RemapOut", Vector) = (0,1,0,0)
		...
		[NoScaleOffset] _HDRPLit_f26a4c9ecbb54d64a38b6207433f7ca6_DetailMap_913208011 ("Texture2D", 2D) = "white" {}
		[NoScaleOffset] _HDRPLit_f26a4c9ecbb54d64a38b6207433f7ca6_EmissiveColorMap_243130236 ("Texture2D", 2D) = "white" {}
